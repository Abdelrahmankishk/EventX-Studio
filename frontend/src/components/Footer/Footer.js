      ...
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p className="footer-description">
            The EventX Studio system solves this by providing an easy-to-use
            Event Management System with separate roles for Admins and Users,
            built with a modern UI/UX
          </p>
        ...
        <div className="footer-section">
          ...
          <div className="contact-info">
            ...
            <div className="contact-item">
              <MapPin size={16} />
              <address>123 431 Liberty Road / Sidi Gaber, Alexandria</address>
            </div>
          </div>
        </div>
      </div>
