...
const API_ROUTE = "https://eventx-studio-production-ffea.up.railway.app:4000";
...
const RegistrationForm = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (props.action === "create") {
      Axios.post(API_ROUTE + "/eventRoute/create-user", formData).then(
        (res) => {
          if (res.status === 200) {
      ...
      Axios.all([
        ...
        Axios.get(API_ROUTE + "/eventRoute/event-list").then(
          (eventResponse) => {
